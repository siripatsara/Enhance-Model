...
class FoodDataAugmentation:
        ...
        self.augment_pipeline = A.Compose([
            ...
            A.OneOf([
                ...
                A.HueSaturationValue(
                    hue_shift_limit=10, sat_shift_limit=20, val_shift_limit=20, p=0.8),
            ...
            A.OneOf([
                ...
                A.RandomSunFlare(flare_roi=(0, 0, 1, 0.5),
                                 angle_lower=0, angle_upper=1, p=0.2),
            ], p=0.2),
            ...
            A.OneOf([
                A.Cutout(num_holes=8, max_h_size=8,
                         max_w_size=8, fill_value=0, p=0.3),
        ...
        for i in range(multiplier):
            try:
                ...
                aug_label_path = self.output_labels_dir / \
                    f"{image_path.stem}_aug_{i+1}.txt"
                ...
                if len(aug_bboxes) > 0:
                    self.save_yolo_labels(
                        aug_bboxes, aug_labels, aug_label_path)
    ...
    def augment_dataset(self, multiplier=3, file_extensions=['.jpg', '.jpeg', '.png']):
        ...
        print(
            f"📈 Generated {len(image_files) * (multiplier + 1)} total images")
